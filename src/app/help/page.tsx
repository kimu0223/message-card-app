...
export const metadata: Metadata = {
  title: withBrandName('ヘルプセンター'),
  description:
    `${brandName}の使い方、よくある質問、トラブルシューティングなど。カードの作成・共有・料金についてお答えします。`,
}
...
const faqData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'テンプレート一覧では、誕生日・お祝い・感謝・季節のイベントなどカテゴリ別に表示されます。プレビューをクリックするとアニメーション付きで確認できます。無料プランでは基本テンプレート5種、Proプランでは全テンプレートをご利用いただけます。',
      },
      {
        question: 'AIメッセージ生成の使い方',
        answer:
          'エディタ画面で「AIで文章を作成」ボタンをクリックし、相手との関係性やシーン（誕生日、感謝など）を選択します。AIが最適なメッセージ候補を複数提案しますので、お好みのものを選んで編集してください。無料プランでは月3回まで、Proプランでは無制限でご利用いただけます。',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          '無料プランで作成したカードは公開後30日間閲覧可能です。Proプランで���無期限でカードを保存・閲覧できます。期限が近づくとメールでお知らせします。',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        question: '無料プランとProプランの���いは？',
        answer:
          '無料プランは月3枚まで作成、AIメッセージ月3回、AIデザイン月1回の基本機能が使えます。Proプラン（月額980円）では、カード作成・AI機能すべて無制限、全テンプレート・全アニメーション利用可能です。Free枠を超えた場合はクレジットパック（都度購入・有効期限なし）でも追加利用できます。',
      },
      {
